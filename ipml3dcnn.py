...
!gdown 1shQl4C1Bs-wAy21w4OX4GgFvUixSI0pU

!unzip /content/HMDB.zip -d /content/
...
x_train_t, x_test_t, y_train_t, y_test_t = train_test_split(train_data, y_train, test_size=0.2, random_state=42)
